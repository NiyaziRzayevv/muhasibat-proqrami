...
export default function LicenseActivation({ onActivated, licenseInfo }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-950 flex items-start sm:items-center justify-center p-4 overflow-y-auto">
